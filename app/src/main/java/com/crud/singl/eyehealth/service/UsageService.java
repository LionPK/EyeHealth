...
import com.crud.singl.eyehealth.db.DBStatUpdater;
import com.crud.singl.eyehealth.receiver.ScreenStatusReceiver;
...
public class UsageService extends Service {
    ...
    private void setAsForeground() {
        ...
        builder.setSmallIcon(R.drawable.ic_timelapse_black_24dp);
