...
public class IntroThreeActivity extends AppCompatActivity {
    ...
    private static final String URL_KNOWLEDGE_THREE = "http://localhost/eye_health/android_knowlage_newapi/knowledge_three.php";

    //the recyclerview
    RecyclerView recyclerView;
    KnowledgeThreeAdapter adapter;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.screen_id:
                        ...
                        Intent intent0 = new Intent(IntroThreeActivity.this, MainActivity.class);
                        startActivity(intent0);
                        break;

                    case R.id.eye_id:
                        bottomNave.setItemBackgroundResource(R.color.colorAccent);
                        Intent intent1 = new Intent(IntroThreeActivity.this, MenuActivity.class);
                        startActivity(intent1);
                        break;

                    case R.id.intro_id:
                        bottomNave.setItemBackgroundResource(R.color.colorPrimary);
                        Intent intent2 = new Intent(IntroThreeActivity.this, IntroHealthActivity.class);
    ...
    private void loadKnowledges() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_KNOWLEDGE_THREE,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new KnowledgeThreeAdapter(IntroThreeActivity.this, knowledgeList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(IntroThreeActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
