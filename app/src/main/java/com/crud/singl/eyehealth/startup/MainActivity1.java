...
import com.crud.singl.eyehealth.miscellaneous.EmptyActivity;

public class MainActivity1 extends AppCompatActivity
    implements NavigationView.OnNavigationItemSelectedListener {

    public static int notificationCounCart = 0;
...
//        }
    ...
    public boolean onCreateOptionsMenu (Menu menu){
        // ขยายเมนู; นี้จะเพิ่มรายการลงในแถบการทำงานถ้ามีอยู่
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        // ดูรายการมุมมองการนำทางคลิกที่นี่
        ...
        if (id == R.id.nav_item1) {
            ...
            startActivity(new Intent(MainActivity1.this, EmptyActivity.class));
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        return true;
